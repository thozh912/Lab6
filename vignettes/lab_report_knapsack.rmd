...
It can be seen that using the matrix the function is faster of more than 1 second.
...
The time to compute this function is less than a second. The time for the same function without parallelizing was about 28 seconds so it can be seen that the performance is improved.