...
system.time(brute_force_knapsack(knapsack_generator()[1:10,],W =2000))
...
```{r}
system.time(knapsack_dynamic(knapsack_generator()[1:50,],W =2000))
```
...
```{r}
system.time(greedy_knapsack(knapsack_generator()[1:10000,],W =2000))
```
...
# brute_force_knapsack(knapsack_matr[1:9,], W = 2000)
# Rprof(NULL)
...
# 
# Rprof(tmp,interval = 0.01)
# brute_force_knapsack(knapsack_df[1:6,], W = 2000)
# Rprof(NULL)
# summaryRprof(tmp)$by.self
